...
if(isset($_GET['id'])){
    ...
    echo "File uploaded successfully: " . $target_file;
        ...
        $sql="UPDATE  product_list SET Product_name='$pro_name',Rate='$rate',Images='$target_file'
              WHERE Id='$id'";
            ...
            <div class="col-lg-4 mt-3">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="id" value="<?php echo $id ?>">
                      ...
                      <input type="text" class="form-control" id="name" name="pro_name" value=
                      "<?php echo $product_name  ?>">
                      <span class="text-danger">*<?php echo $pro_nameErr;?></span><br>
                    
                      <label for="rate">Rate:</label>
                      <input type="number" class="form-control" id="rate" name="rate" value="<?php echo $rate ?>">
                      <span class="text-danger">*<?php echo $rateErr;?></span><br>

                      
                      <input type="file" class="form-control" name="upload" id="upload">
                      <label for="upload" class="d-block"><?php echo $images; ?></label>
                      <?php

                      echo "<img src='$images' style='max-width: 200px;
                                    max-height: 100px;' class='ml-5'>";
                      ?>  
